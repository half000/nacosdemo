...
public class ClientWorker {
    ...
    void removeCache(String dataId, String group) {
        ...
        removeCacheBase(groupKey);
    }

    void removeCacheBase(String groupKey){
        ...
        public void run() {
            ...
            try {
                ...
                for (CacheData cacheData : cacheDatas) {
                    ...
                    //System.out.println("!cacheData.isInitializing()="+(!cacheData.isInitializing())+" inInitializingCacheList.contains = "+inInitializingCacheList.contains(GroupKey.getKeyTenant(cacheData.dataId, cacheData.group, cacheData.tenant)));
                }
                ...
                executorService.getScheduledExecutor().schedule(this, taskPenaltyTime, TimeUnit.MILLISECONDS);
            }
        }
    }
...
//Runtime.getRuntime().availableProcessors()
    ...
    static final ThreadPoolTaskScheduler executor;
    static final ThreadPoolTaskScheduler executorService;
